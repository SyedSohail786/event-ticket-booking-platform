...
function HeroCarousel() {
  ...
  return (
    <div className="flex mt-2 justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-6xl relative h-[300px] md:h-[400px] lg:h-[500px] rounded-xl shadow-xl overflow-hidden">
        ...
        <div className="absolute bottom-4 left-0 right-0 z-20 flex justify-center gap-2">
          {banners.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 md:w-3 md:h-3 rounded-full transition-all duration-300 ${index === current ? 'bg-white w-4 md:w-6' : 'bg-white/50'}`}
